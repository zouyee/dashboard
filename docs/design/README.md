...
* Follow the [Getting started guide](https://gerrit.cmss.com/BC-PaaS/backend/blob/master/docs/devel/getting-started.md) to get the most recent version of Dashboard up and running.
