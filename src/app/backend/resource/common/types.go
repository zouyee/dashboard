...
const (
	...
	ResourceKindComponentStatus         = "componentstatus"
)
...
const (
	...
	ClientTypeBatchAlphaClient  = "batchv2alpha1client"
...
var kindToAPIMapping = map[string]struct {
	...
	ResourceKindCronJob:                 {"cronjobs", ClientTypeBatchAlphaClient, true},
	...
	ResourceKindComponentStatus:         {"componentstatuses", ClientTypeDefault, false},
}
